            ...
            when: {
                everyDay: {
                    ...
                    validate: {
                        ...
                        message: (props) => `${props.value} is not a valid time! Use format HH:mm AM/PM.`,
                    },
                },
                everyWeek: {
                    type: String,
    ...
    switch (interval) {
        ...
        case "Every year":
            if (!when.everyYear) {
                ...
                if (!when.everyYear.month) this.recuring.when.everyYear.month = "January";
...
module.exports = mongoose.model("RecuringTransaction", recuringTransactionSchema);
